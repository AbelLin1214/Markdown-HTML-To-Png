/*
 * @Author: Abel
 * @Date: 2022-12-27 22:49:30
 * @LastEditTime: 2022-12-27 23:56:21
 */
! function () {
    if ("undefined" != typeof Prism && "undefined" != typeof document) {
        ...
        if (a) {
            var r = /\bplugins\/autoloader\/prism-autoloader\.(?:min\.)?js(?:\?[^\r\n/]*)?$/i,
                s = /(^|\/)[\w-]+\.(?:min\.)?js(?:\?[^\r\n/]*)?$/i,
                // to partly use local js, here we change the path to a normal url
                // i = a.getAttribute("data-autoloader-path");
                i = "https://cdnjs.cloudflare.com/ajax/libs/prism/1.26.0/components";
        ...
        Prism.hooks.add("complete", function (e) {
            ...
            if (a && r && "none" !== r) {
                ...
                /^diff-./i.test(r) ? (s.push("diff"), s.push(r.substr("diff-".length))) : s.push(r), s.every(m) || u(s, function () {
            ...
            ! function (a, r, s) {
                ...
                function e() {
                    ...
                    e || (e = p[a] = {
                        ...
                        success: r,
                        error: s
                    }), !i && m(a) ? k(a, "success") : !i && e.error ? k(a, "error") : !i && e.loading || (e.loading = !0, e.error = !1, function (e, a, r) {
